...
function createCards() {
	...
	<div class="col">
		<div class="card">
			<img class="card-img-top" style="height: 300px;" src=${obj.img}>
			<div class="card-body">
				<h5 class="card-title">${obj.title}</h5>
				<a href="#" class="btn btn-primary" data-btn="price" data-id="${obj.id}">Посмотреть цену</a>
				<a href="#" class="btn btn-danger" data-btn="remove" data-id="${obj.id}">Удалить</a>
			</div>
		</div>
	</div>
	`
